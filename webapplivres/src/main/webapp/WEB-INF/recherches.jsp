...
<head>
    ...
    <link type="text/css" href="<%=System.getenv("ENVLocalhost")%>/resources/mycss/recherches.css" rel="stylesheet">
                ...
                <div id="paneldescription" class="card-body">
                    ...
                    <!-- imgPath -->
                        <div class="cadrephoto" class="card">
                            <a target="_blank" href="redirectionLivre?id=${chaquelivre.idLivre}"><img class="cadrephoto" src="<%=System.getenv("ENVLocalhost")%>/resources/img/livre8.png"></a>
                        </div>
                    <!-- imgPath -->
