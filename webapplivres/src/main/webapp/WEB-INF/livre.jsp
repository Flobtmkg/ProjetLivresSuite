...
<html>
    <head>
        ...
        <link type="text/css" href="<s:i18n name="application"><s:text name="ENVLocalhost"/></s:i18n>/resources/mycss/livre.css" rel="stylesheet">
...
<div class="container-fluid">
    <div id="cadrephoto" class="offset-sm-1" style="background: url(<s:i18n name="application"><s:text name="ENVLocalhost"/></s:i18n>/resources/img/livre8.png) center no-repeat; background-size: 100% auto; background-color:rgba(0, 0, 0, 0.6)"></div>
