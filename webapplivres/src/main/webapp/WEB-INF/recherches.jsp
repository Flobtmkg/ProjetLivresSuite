...
<head>
    ...
    <link type="text/css" href="<s:i18n name="application"><s:text name="ENVLocalhost"/></s:i18n>/resources/mycss/recherches.css" rel="stylesheet">
                ...
                <div id="paneldescription" class="card-body">
                    ...
                    <!-- imgPath -->
                        <div class="cadrephoto" class="card">
                            <a target="_blank" href="redirectionLivre?id=${chaquelivre.idLivre}"><img class="cadrephoto" src="<s:i18n name="application"><s:text name="ENVLocalhost"/></s:i18n>/resources/img/livre8.png"></a>
                        </div>
                    <!-- imgPath -->
